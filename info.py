...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>{title} [{year} {kind}]</b><br>⏰𝗥𝘂𝗻𝗧𝗶𝗺𝗲: <b>{runtime} Min/Episode</b><br>🌟𝗥𝗮𝘁𝗶𝗻𝗴: <b>{rating}/10 (based on {votes} votes)</b><br>🎭𝗚𝗲𝗻𝗿𝗲: <b>{genres}</b><br>♨️𝗡𝗼. 𝗼𝗳 𝗦𝗲𝗮𝘀𝗼𝗻𝘀: <b>{seasons}</b><br>🔊𝗟𝗮𝗻𝗴𝘂𝗮𝗴𝗲𝘀: <b>{languages}</b><br>📜𝗦𝘁𝗼𝗿𝘆 𝗟𝗶𝗻𝗲: <a href={url}/plotsummary>Read here...</a>")
